...
namespace Chempoint.GP.FtpBL.CtsiFTPLibrary
{
    ...
    public interface IFtpClient {
        ...
        /// </summary>
        FtpCapabilities Capabilities { get; }
        ...
        /// Added for the MoQ unit testing framework
        /// </summary>
        event FtpSslValidationEventHandler ValidateCertificate;
        ...
        void DeleteDirectory(string path, bool force, FtpListOptions options);
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        bool FileExists(string path, FtpListOptions options);
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        FtpListItem[] GetListing(string path, FtpListOptions options);
        ...
        /// <param name="state"></param>
        /// <returns></returns>
        IAsyncResult BeginDeleteDirectory(string path, bool force, FtpListOptions options, AsyncCallback callback, object state);
        ...
        /// <param name="state"></param>
        /// <returns></returns>
        IAsyncResult BeginFileExists(string path, FtpListOptions options, AsyncCallback callback, object state);
        ...
        /// <param name="state"></param>
        /// <returns></returns>
        IAsyncResult BeginGetListing(string path, FtpListOptions options, AsyncCallback callback, object state);
        ...
        /// <param name="state"></param>
        /// <returns></returns>
        IAsyncResult BeginRename(string path, string destination, AsyncCallback callback, object state);
