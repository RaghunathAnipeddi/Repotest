...
{
    public class ProcessDistributionIssues : ISalesOrderPostBL
    {
        ...
        public OrderBatchPostResponse Process(OrderBatchPostRequest batchRequest)
        {
            ...
            try
            {
                ...
                batchResponse = salesDataAcess.GetAllDistributionErrorTransactions(batchRequest, batchRequest.CompanyID);
