...
{
    public class ProcessServiceSkuIssues : ISalesOrderPostBL
    {
        ...
        public OrderBatchPostResponse Process(OrderBatchPostRequest batchRequest)
        {
            ...
            try
            {
                ...
                batchResponse = salesDataAcess.GetAllServiceSkuErrorTransactions(batchRequest, batchRequest.CompanyID);
