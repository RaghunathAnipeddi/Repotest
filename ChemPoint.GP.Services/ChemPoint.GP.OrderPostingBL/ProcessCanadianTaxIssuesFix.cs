...
{
    public class ProcessCanadianTaxIssuesFix : ISalesOrderPostBL
    {
        public OrderBatchPostResponse Process(OrderBatchPostRequest batchRequest)
        {
            ...
            try
            {
                ...
                batchResponse = salesDataAcess.GetAllCanadianErrorTransactions(batchRequest, batchRequest.CompanyID);                
