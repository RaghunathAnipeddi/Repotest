...
{
    public class ProcessVatIssues : ISalesOrderPostBL
    {
        ...
        public OrderBatchPostResponse Process(OrderBatchPostRequest batchRequest)
        {
            ...
            try
            {
                ...
                batchResponse = salesDataAcess.GetAllIncorrectTaxScheduleIdTranscations(batchRequest, batchRequest.CompanyID);
