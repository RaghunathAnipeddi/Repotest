...
{
    public class ProcessMissingShipViaIssues : ISalesOrderPostBL
    {
        ...
        public OrderBatchPostResponse Process(OrderBatchPostRequest batchRequest)
        {
            ...
            try
            {
                ...
                batchResponse = salesDataAcess.GetAllMissingShipViaTransactions(batchRequest, batchRequest.CompanyID);
