...
{
    public class ProcessPostTransactions : ISalesOrderPostBL
    {
        ...
        public OrderBatchPostResponse Process(OrderBatchPostRequest batchRequest)
        {
            ...
            try
            {
                ...
                salesDataAcess.UnLockBatchforPosting(batchRequest, batchRequest.CompanyID);
                batchResponse = salesDataAcess.FetchNumTrxandBatchTotal(batchRequest, batchRequest.CompanyID);
