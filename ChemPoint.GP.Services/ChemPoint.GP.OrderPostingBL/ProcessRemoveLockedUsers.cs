...
{
    public class ProcessRemoveLockedUsers : ISalesOrderPostBL
    {
        public ProcessRemoveLockedUsers()
        {
        }
        ...
        public OrderBatchPostResponse Process(OrderBatchPostRequest batchRequest)
        {
            ...
            try
            {
                ...
                batchResponse = salesDataAcess.RemoveBatchLockedUsers(batchRequest, batchRequest.CompanyID);
