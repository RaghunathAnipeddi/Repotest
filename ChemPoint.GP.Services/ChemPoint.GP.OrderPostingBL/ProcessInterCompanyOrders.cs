...
{
    public class ProcessInterCompanyOrders : ISalesOrderPostBL
    {
        ...
        public OrderBatchPostResponse Process(OrderBatchPostRequest batchRequest)
        {
            ...
            try
            {
                ...
                batchResponse = salesDataAcess.GetAllInterCompanyTransactions(batchRequest, batchRequest.CompanyID);
